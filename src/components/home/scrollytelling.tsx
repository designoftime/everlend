...
export function Scrollytelling() {
  ...
  return (
    <section ref={containerRef} className="bg-page py-20 md:py-32 ">
      <Container>
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-35 items-center max-sm:items-center">
          {/* Sticky Left Content */}
          <div className="lg:w-1/3 lg:h-auto lg:top-24 flex flex-col justify-center mb-12 lg:mb-0">
            <motion.div
        ...
        {/* Amount Table */}
          ...
          <div className="w-[54%] md:w-[60%] max-sm:ml-[-18.1rem] max-sm:w-[24%]" >
